...
public class TaskCut implements IMaidTask {
    public static final ResourceLocation UID = new ResourceLocation(MaidBakeries.MODID, "cut");
    ...
    private boolean hasKnife(EntityMaid maid) {
        return maid.getMainHandItem().is(BakeriesItems.BREAD_KNIFE.get()) || maid.getMainHandItem().is(ItemTags.create(new ResourceLocation("forge:tools/knives")));
    }
